 ...
 * 번호가 순서대로 적혀져 있다. 바구니는 일렬로 놓여져 있고, 
 ...
 * M번 바구니의 순서를 회전시킨 다음, 바구니에 적혀있는 번호를 
 * 가장 왼쪽 바구니부터 출력하는 프로그램을 작성하시오.
 * 
 * - 입력
 * 첫째 줄에 N (1 ≤ N ≤ 100)과 M (1 ≤ M ≤ 100)이 주어진다.
 * 둘째 줄부터 M개의 줄에는 바구니의 순서를 바꾸는 만드는 방법이 주어진다. 
 * 방법은 i, j, k로 나타내고, 왼쪽으로부터 i번째 바구니부터 j번째 바구니의 
 * 순서를 회전시키는데, 그 때 기준 바구니는 k번째 바구니라는 뜻이다. (1 ≤ i ≤ k ≤ j ≤ N)
